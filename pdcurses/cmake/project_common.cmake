...
set(PDCURSES_SRCDIR ${CMAKE_SOURCE_DIR}/pdcurses)
...
if(WIN32 AND NOT WATCOM)
    ...
    set(EXTRA_LIBS winmm.lib gdi32.lib winspool.lib shell32.lib ole32.lib comdlg32.lib advapi32.lib)
    set(a_WINGUI_DEP_LIBS winmm.lib)
